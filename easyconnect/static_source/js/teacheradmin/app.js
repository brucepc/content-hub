...
var app = angular.module('ecApp', [
    'ng.django.urls', 'ecServices', "taControllers", "taFilters", "commonControllers", "taDirectives", "ngRoute", 'ngResource', 'RecursionHelper', 'toaster', 'xeditable', 'ngCookies', 'LocalStorageModule', 'ngTouch', 'blockUI', 'angularFileUpload',
])
...
app.config(function ($httpProvider, $interpolateProvider, $routeProvider, $resourceProvider, blockUIConfig) {
    ...
    function ($http, $cookies, editableThemes, $rootScope, $location, userService) {
